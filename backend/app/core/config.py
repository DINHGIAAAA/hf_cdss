...
class Settings(BaseSettings):
    ...
    clinical_entity_boost_lab_critical_weight: float = 0.12
    clinical_entity_boost_lab_monitor_weight: float = 0.06
    clinical_entity_boost_drug_class_weight: float = 0.10
    clinical_entity_boost_drug_name_weight: float = 0.08
    clinical_entity_boost_condition_weight: float = 0.05
    clinical_entity_boost_safety_weight: float = 0.09
    clinical_entity_boost_general_weight: float = 0.03
    clinical_entity_boost_lab_critical_cap: int = 2
    clinical_entity_boost_lab_monitor_cap: int = 1
    clinical_entity_boost_drug_class_cap: int = 2
    clinical_entity_boost_drug_name_cap: int = 2
    clinical_entity_boost_condition_cap: int = 2
    clinical_entity_boost_safety_cap: int = 2
    clinical_entity_boost_general_cap: int = 3
    clinical_entity_threshold_boost_max: float = 0.22
    clinical_entity_threshold_abnormal_multiplier: float = 1.15
    clinical_entity_threshold_critical_multiplier: float = 1.35
    clinical_entity_patient_lab_affinity_multiplier: float = 1.40
    clinical_entity_patient_critical_multiplier: float = 1.65
    clinical_entity_section_renal_boost: float = 0.07
    clinical_entity_section_potassium_boost: float = 0.06
    clinical_entity_section_bp_boost: float = 0.05
    clinical_entity_section_hr_boost: float = 0.05
    clinical_entity_section_safety_boost: float = 0.04
