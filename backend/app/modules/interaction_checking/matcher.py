...
_STATIC_CLASS_MEMBERS: dict[str, set[str]] = {
    ...
    "class:sglt2i": {"dapagliflozin", "empagliflozin", "canagliflozin", "ertugliflozin"},
    "class:beta_blocker": {
    ...
    "class:non_dhp_ccb": {"verapamil", "diltiazem", "verapamil_hydrochloride", "diltiazem_hydrochloride"},
    "class:ccb": {
        "verapamil",
        "diltiazem",
        "amlodipine",
    ...
    "class:insulin": {"insulin", "insulin_glargine", "insulin_lispro", "insulin_aspart"},
