CARD_SUMMARY_SYSTEM_PROMPT = (
    ...
    "4. response_language='vi' → clear Vietnamese with diacritics for EVERY text field; "
    "'en' → plain clinical English. Never use Chinese, Japanese, or Korean unless "
    "response_language explicitly requests that language. Do not leave raw English jargon in vi output.\n"
