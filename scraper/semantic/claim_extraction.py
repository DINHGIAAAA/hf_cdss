...
LLM_SYSTEM_PROMPT = """You extract prescriptive clinical claims from FDA drug labels and cardiology guidelines.
...
def extract_claims_from_section(record: dict) -> list[dict]:
    ...
    payload = call_llm_json(LLM_SYSTEM_PROMPT, user_prompt)
    if not payload:
        return []
