...
LLM_MAX_RETRIES = _env_int("HF_CDSS_LLM_MAX_RETRIES", 3)
LLM_MAX_TOKENS = _env_int("HF_CDSS_INGESTION_LLM_MAX_TOKENS", 800)
LLM_CONCURRENCY = _env_int("HF_CDSS_LLM_CONCURRENCY", 2)
...
LLM_CACHE_MAX_ENTRIES = _env_int("HF_CDSS_LLM_CACHE_MAX_ENTRIES", 5000)
...
SECTION_SIMILARITY_THRESHOLD = _env_float("HF_CDSS_SECTION_SIMILARITY_THRESHOLD", 0.50)
# Embed scores in [borderline_low, keep_threshold) get a cheap LLM keep/drop check.
SECTION_BORDERLINE_LOW_THRESHOLD = _env_float("HF_CDSS_SECTION_BORDERLINE_LOW_THRESHOLD", 0.38)
...
SECTION_BORDERLINE_LLM_MAX = _env_int("HF_CDSS_SECTION_BORDERLINE_LLM_MAX", 400)
SECTION_BORDERLINE_LLM_MAX_TOKENS = _env_int("HF_CDSS_SECTION_BORDERLINE_LLM_MAX_TOKENS", 100)
...
# Increased for better extraction quality on CPU Ollama (qwen2.5:7b handles longer context)
MAX_LLM_SECTION_CHARS = _env_int("HF_CDSS_MAX_LLM_SECTION_CHARS", 3500)
MAX_LLM_CLAIMS_PER_SECTION = _env_int("HF_CDSS_MAX_LLM_CLAIMS_PER_SECTION", 8)
