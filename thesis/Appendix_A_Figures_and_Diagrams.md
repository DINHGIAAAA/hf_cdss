...
<figure class="thesis-archify-figure">
  <iframe src="figures/html/figure-a5-datastores.html" title="Figure A.5 Data stores"></iframe>
  <figcaption><strong>Figure A.5.</strong> Database schema overview (PostgreSQL governance catalogs, Neo4j, ChromaDB, Redis)</figcaption>
</figure>
