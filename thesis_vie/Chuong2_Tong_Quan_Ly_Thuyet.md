...
Chương này trình bày khái niệm và nền tảng lý thuyết cho thiết kế HF-CDSS. Bối cảnh lâm sàng, mục tiêu, phạm vi và cách tiếp cận đã nêu ở Chương 1. Trích dẫn theo `References.md`.

## 2.0 Ghi chú định hướng

Không lặp lại mục 1.1 và 1.2. Phần dưới giải thích CDSS, đồ thị tri thức, RAG, LLM, GraphRAG và nền HFrEF để đọc Chương 3.
