    ...
    <div className="admin-page admin-page--evidence">
      ...
      {result && (
        <div className="evidence-layout">
          <section className="evidence-meta admin-clip">
          ...
          {chunks.length === 0 ? (
            <div className="admin-empty">No chunks returned for this query.</div>
          ) : (
            <ResizableSplit
                  ...
                  <article className="chunk-detail">
                    ...
                    <div className="chunk-detail-body">
                      ...
                      {activeChunk.source_link && (
                        <a className="source-link text-break" href={activeChunk.source_link} rel="noreferrer" target="_blank">
