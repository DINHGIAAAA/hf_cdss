  ...
  vi: {
    ...
    chat: {
      ...
      stream: {
        ...
        regex_semantic: "Đang đọc xét nghiệm, thuốc, sinh hiệu...",
        llm_extraction: "Đang tinh chỉnh hồ sơ bằng mô hình ngôn ngữ...",
        profile_complete_regex: "Đang cập nhật số liệu từ tin nhắn...",
    ...
    clinicalPanel: {
      ...
      evidence: "Bằng chứng",
      tabClinical: "GDMT",
      tabEvidence: "Bằng chứng",
      evidenceEmpty: "Bằng chứng sẽ hiển thị sau khi truy xuất xong.",
    ...
    clinicalAnswer: {
      overall: "Tổng quan",
      conclusionHeading: "Kết luận",
      conclusionAvoid: "Tránh hoặc hoãn: {drugs}.",
      conclusionCaution: "Thận trọng với: {drugs}.",
      conclusionConsider: "Cân nhắc nếu phù hợp: {drugs}.",
      conclusionContinue: "Tiếp tục: {drugs}.",
      vitalsInline: "Dữ liệu chính",
      constraintsHeading: "Ràng buộc an toàn",
      monitoringHeading: "Theo dõi",
      evidenceCount: "{count} đoạn bằng chứng — xem tab Bằng chứng ở panel phải",
      gdmtTable: "GDMT theo nhóm thuốc",
      vitalsTable: "Sinh hiệu & xét nghiệm chính",
      constraintsTable: "Ràng buộc an toàn",
      doseTable: "Kiểm tra liều",
      pathwayHeading: "Lộ trình thuốc (theo labs)",
      pathwayStep: "Bước {n}",
      pathwayDrug: "Thuốc",
      pathwayRecStatus: "Trạng thái CDSS",
      pathwayPhase: {
        active: "Đang dùng",
        next: "Tiếp theo",
        hold: "Tạm hoãn — labs",
